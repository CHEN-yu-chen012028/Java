...
public class PinholeCameraModel {
    ...
    public static double estimateHeight(Point2D.Double vp, Point2D.Double baseFoot, Point2D.Double baseHead, double baseHeight, Point2D.Double targetFoot, Point2D.Double targetHead) {
        ...
        // 根據透視投影原理，物體在圖像中的高度與其到消失點的垂直距離成反比
        // H_target / H_base = (h_target_pixel / h_base_pixel) * ((baseFoot.getY() - vp.getY()) / (targetFoot.getY() - vp.getY()))
    ...
    public static void main(String[] args) {
        System.out.println("--- 消失點身高測量程式 ---");


        // --- 圖片 pic1(1).jpg 的身高測量 ---
        System.out.println("\n--- 圖片 pic1(1).jpg 身高估算 ---");
        Point2D.Double vp1 = new Point2D.Double(850, 950);
        ...
        Point2D.Double target1Head = new Point2D.Double(320, 1080);
        ...
        Point2D.Double target3Head = new Point2D.Double(420, 1110);
